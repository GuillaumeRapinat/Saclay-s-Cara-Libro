...
public class Vue_Utilisateur extends JFrame {
	...
	private IdButton boutonPublier;
	...
	private Controleur_Message controleurMessage;
	...
	public Vue_Utilisateur(Controleur_Utilisateur controleurUtilisateur, Modele_Utilisateur modeleUtilisateur) {
		...
		controleurMur = new Controleur_Mur(this, controleurUtilisateur);  // on est oblig� de cr�er le controleur avant
		vueMur = new Vue_Mur(controleurMur);
		controleurMur.setVueMur(vueMur);
		...
		boutonPublier = new IdButton (new ImageIcon(getClass().getClassLoader().getResource("images/boutons_publier.png")));
		...
		boutonRechercher = new JButton("Rechercher");
			...
			boutonRechercher.setBackground(Vue_Recherche.MARRONCLAIR);
			boutonRechercher.setCursor(new Cursor(Cursor.HAND_CURSOR));
	/*	boutonChat = new JButton("Chat");
			boutonChat.setBackground(Vue_Recherche.MARRONCLAIR);
			boutonChat.setFont(FONT);
		*/	
...
/*//seulement visible dans le profil ami, il permet d'être placé comme il faut		
		...
		controleurMessage = new Controleur_Message(textePublier, objet);
		...
		boutonPublier.setActionCommand(Controleur_Mur.ACTION_PUBLIER);
		boutonPublier.addActionListener(controleurMur);
		boutonAjouter.setActionCommand(Controleur_Mur.ACTION_AJOUTER_PHOTO);
		boutonAjouter.addActionListener(controleurMur);
		titreImage.setActionCommand(Controleur_Mur.ACTION_ENLEVER_PHOTO);
		titreImage.addActionListener(controleurMur);
		boutonMessage.setActionCommand(Controleur_Message.ACTION_OUVRIR_MESSAGERIE);
		boutonMessage.addActionListener(controleurMessage);
...
*/
	...
	public void autreProfil() {
		...
		textePublier.setText("Ecrire un message");
		boutonAjouter.setVisible(false);
		titreImage.setVisible(false);
		objet.setVisible(true);
		
		boutonPublier.setId(modeleUtilisateur.getId());
		boutonPublier.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/boutons_envoyer.png")));
		boutonPublier.setActionCommand(Controleur_Message.ACTION_ENVOYER_MSG);
		boutonPublier.addActionListener(controleurMessage);
	}
	...
	public void revenirProfil() {
		...
		boutonPublier.setIcon(new ImageIcon(getClass().getClassLoader().getResource("images/boutons_publier.png")));
		boutonPublier.setActionCommand(Controleur_Mur.ACTION_PUBLIER);
		boutonPublier.addActionListener(controleurMur);
	}
	...
	public void setTitreImage(String name) {
		titreImage.setText(name);
	}
