...
public class Controleur_Message implements ActionListener {
	...
	public static final String ACTION_ENVOYER_MSG = "ENVOYER MSG";
	public static final String ACTION_OUVRIR_MESSAGERIE = "MESSAGERIE";
	...
	public Controleur_Message(JTextArea message, JTextField objet) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		case ACTION_ENVOYER_MSG:
			IdButton button = (IdButton) e.getSource();
			Modele_Message.envoyer(objet.getText(), message.getText(), button.getId());
			break;
		case ACTION_OUVRIR_MESSAGERIE:
			new Vue_Message(this);
			break;
			switch(e.getActionCommand()) {
